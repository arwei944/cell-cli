...
impl FingerprintCategory {
    pub fn description(&self) -> &'static str {
        match self {
            FingerprintCategory::Architecture => "架构问题",
            FingerprintCategory::Performance => "性能问题",
            FingerprintCategory::Security => "安全问题",
            FingerprintCategory::Maintainability => "可维护性问题",
            FingerprintCategory::Testing => "测试问题",
            FingerprintCategory::Dependency => "依赖问题",
            FingerprintCategory::Configuration => "配置问题",
        }
    }
}

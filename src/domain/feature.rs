...
impl FeatureFlagType {
    pub fn as_str(&self) -> &'static str {
        match self {
            FeatureFlagType::Release => "release",
            FeatureFlagType::Ops => "ops",
            FeatureFlagType::Experiment => "experiment",
            FeatureFlagType::Permission => "permission",
        }
    }

    pub fn description(&self) -> &'static str {
        match self {
            FeatureFlagType::Release => "功能发布开关 - 控制新功能的逐步发布",
            FeatureFlagType::Ops => "运维控制开关 - 控制运维相关的功能",
            FeatureFlagType::Experiment => "实验开关 - A/B测试和灰度发布",
            FeatureFlagType::Permission => "权限开关 - 控制用户权限相关功能",
        }
    }
}

...
impl DegradationLevel {
    pub fn label(&self) -> &str {
        match self {
            DegradationLevel::L0 => "Normal",
            DegradationLevel::L1 => "Performance Degradation",
            DegradationLevel::L2 => "Feature Degradation",
            DegradationLevel::L3 => "Core Limited",
            DegradationLevel::L4 => "System Failsafe",
        }
    }

    pub fn description(&self) -> &str {
        match self {
            DegradationLevel::L0 => "系统正常运行，所有功能可用",
            DegradationLevel::L1 => "非关键功能性能下降，核心功能正常",
            DegradationLevel::L2 => "部分功能关闭，核心功能保留",
            DegradationLevel::L3 => "仅核心功能运行，其余降级",
            DegradationLevel::L4 => "系统进入安全模式，仅保活",
        }
    }

    pub fn from_usize(level: usize) -> Option<Self> {
        match level {
            0 => Some(DegradationLevel::L0),
            1 => Some(DegradationLevel::L1),
            2 => Some(DegradationLevel::L2),
            3 => Some(DegradationLevel::L3),
            4 => Some(DegradationLevel::L4),
            _ => None,
        }
    }
...
impl FeatureStatus {
    pub fn label(&self) -> &str {
        match self {
            ...
            FeatureStatus::Failsafe => "Failsafe",
        }
    }
}
    ...
    fn transition_to(&mut self, target: DegradationLevel) {
        ...
        for feature in self.features.values_mut() {
            ...
            match feature.current_status {
                ...
                FeatureStatus::Disabled => disabled.push(feature.feature_id.clone()),
                FeatureStatus::Failsafe => disabled.push(feature.feature_id.clone()),
            }
        }

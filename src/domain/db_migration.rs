...
impl fmt::Display for MigrationStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            MigrationStatus::Applying => write!(f, "Applying"),
...
impl fmt::Display for MigrationType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            MigrationType::Data => write!(f, "Data"),
            MigrationType::Index => write!(f, "Index"),
            MigrationType::Config => write!(f, "Config"),
        }
    }
}
...
impl fmt::Display for MigrationError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            MigrationError::NotFound(v) => write!(f, "Migration not found: {}", v),
            MigrationError::AlreadyApplied(v) => write!(f, "Migration already applied: {}", v),
            MigrationError::AlreadyRegistered(v) => {
                write!(f, "Migration already registered: {}", v)
            }
            MigrationError::InvalidVersion(v) => write!(f, "Invalid version: {}", v),
            MigrationError::ChainBroken(v) => write!(f, "Migration chain broken at: {}", v),
            MigrationError::ApplyFailed(v) => write!(f, "Apply failed: {}", v),
            MigrationError::RollbackFailed(v) => write!(f, "Rollback failed: {}", v),
            MigrationError::ChecksumMismatch(v) => write!(f, "Checksum mismatch: {}", v),
        }
    }
}
...
mod tests {
    ...
    fn test_migrate_all_failure_rollback() {
        ...
        bad_migration.up_sql = "".to_string();

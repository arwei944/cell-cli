...
impl RCAEngine {
            ...
            for rule in &self.rules {
                ...
                if match_score > 0.0 {
                    ...
                    *entry += match_score * rule.weight;
                    ...
                    let evidence = component_evidence.entry(signal.component.clone()).or_insert_with(Vec::new);
    ...
    pub fn trace_causality_chain(
        &self,
        graph: &crate::domain::dependency_graph::DependencyGraph,
        failing_component: &str,
    ) -> Vec<CausalLink> {
        use crate::domain::dependency_graph::NodeId;
...
impl SignalType {
    pub fn label(&self) -> &str {
        match self {
            SignalType::MetricAnomaly => "Metric Anomaly",
            SignalType::LogError => "Log Error",
            SignalType::TraceError => "Trace Error",
            SignalType::HealthCheckFail => "Health Check Fail",
            SignalType::UserReported => "User Reported",
...
pub struct CausalLink {
    pub from: String,
    pub to: String,
    pub relationship: crate::domain::dependency_graph::EdgeType,
    pub strength: f64,
}

...
impl PatternCategory {
    pub fn label(&self) -> &str {
        match self {
            ...
            PatternCategory::Maintainability => "Maintainability",
...
impl PatternSeverity {
    ...
    pub fn weight(&self) -> f64 {
        match self {
            ...
            PatternSeverity::Warning => 2.0,
            PatternSeverity::Major => 5.0,
            PatternSeverity::Critical => 10.0,
        }
    }
}
...
impl RuleType {
    pub fn label(&self) -> &str {
        match self {
            ...
            RuleType::Structural => "Structural",
            RuleType::Naming => "Naming",
        ...
        for pattern in self.patterns.values() {
            ...
            if result.confidence > 0.0 {
                *category_scores
                    ...
                    .or_insert(0.0) += result.severity.weight() * result.confidence;

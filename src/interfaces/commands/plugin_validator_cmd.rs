use crate::application::plugin_validator_service::PluginValidatorService;
...
pub fn cmd_plugin_validate(args: PluginValidatorArgs) -> CellResult<()> {
    ...
    match args.sub {
        ...
        PluginValidatorSub::Audit { path, json } => {
            ...
            if result.summary.risk_level == crate::application::plugin_validator_service::RiskLevel::Critical {
                std::process::exit(1);
            }
        }
    }

use crate::application::ab_test_service::ABTestService;
use crate::domain::ab_experiment::ExperimentType;
...
fn parse_experiment_type(s: Option<&str>) -> CellResult<ExperimentType> {
    ...
    match s.to_lowercase().as_str() {
        ...
        _ => Err(crate::domain::errors::CellError::Validation(format!(
            "Unknown experiment type: {}. Valid: ui, algorithm, feature, price", s
        ))),
    }
}

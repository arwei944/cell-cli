use crate::application::config_service::{CellConfig, ConfigService};
use crate::application::coverage_service::CoverageService;
use crate::application::fast_verify_service::FastVerifyService;
use crate::application::progress_bar::StepProgress;
use crate::application::simplicity_checker::SimplicityChecker;
    ...
    F: FnOnce() -> CellResult<()>,
{
    progress.start_next();
    match check() {
        Ok(_) => progress.complete_current(),
        Err(e) => {

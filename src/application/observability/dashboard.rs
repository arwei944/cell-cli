...
use crate::domain::decision::simple_id;
...
pub fn build_dashboard(
    ...
    decisions: &[crate::domain::decision::DecisionRecord],
    evolution: Option<&crate::domain::evolution::EvolutionLog>,
...
fn build_recent_decisions(decisions: &[crate::domain::decision::DecisionRecord]) -> Vec<DecisionSummary> {
...
fn build_evolution_counts(evolution: Option<&crate::domain::evolution::EvolutionLog>) -> (usize, usize) {
    evolution.as_ref().map_or((0, 0), |e| (e.issues.len(), e.improvements.len()))
}

fn aggregate_task_counts(phases: &[crate::domain::observability::ProjectPhase]) -> (usize, usize) {

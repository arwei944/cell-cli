...
impl DecisionCategory {
    pub fn label(&self) -> &str {
        match self {
            Self::Architecture => "架构决策",
            Self::Technology => "技术选型",
            Self::Process => "流程决策",
            Self::Tooling => "工具决策",
            Self::Design => "设计决策",
            Self::Testing => "测试决策",
            Self::Deployment => "部署决策",
            Self::Security => "安全决策",
            Self::Performance => "性能决策",
            Self::Other => "其他决策",
        }
    }
    ...
    pub fn from_str(s: &str) -> Option<Self> {
        match s.to_lowercase().as_str() {
            "arch" | "architecture" => Some(Self::Architecture),
            "tech" | "technology" => Some(Self::Technology),
            "process" => Some(Self::Process),
            "tool" | "tooling" => Some(Self::Tooling),
            "design" => Some(Self::Design),
            "test" | "testing" => Some(Self::Testing),
            "deploy" | "deployment" => Some(Self::Deployment),
...
impl ImpactLevel {
    pub fn label(&self) -> &str {
        match self {
            Self::PositiveHigh => "强正面",
            Self::PositiveMedium => "中正面",
            Self::PositiveLow => "弱正面",
            Self::Neutral => "中性",
            Self::NegativeLow => "弱负面",
            Self::NegativeMedium => "中负面",
            Self::NegativeHigh => "强负面",
        }
    }

    pub fn from_str(s: &str) -> Option<Self> {
        match s.to_lowercase().as_str() {
            "++" | "positive-high" | "strong-positive" => Some(Self::PositiveHigh),
            "+" | "positive-medium" | "medium-positive" => Some(Self::PositiveMedium),
            "+-" | "positive-low" | "weak-positive" => Some(Self::PositiveLow),
            "0" | "neutral" => Some(Self::Neutral),
            "-+" | "negative-low" | "weak-negative" => Some(Self::NegativeLow),
            "-" | "negative-medium" | "medium-negative" => Some(Self::NegativeMedium),
            "--" | "negative-high" | "strong-negative" => Some(Self::NegativeHigh),
            _ => None,
        }
    }
}

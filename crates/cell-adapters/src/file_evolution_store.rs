use cell_application::ports::evolution_store::EvolutionStorePort;
use cell_domain::errors::CellResult;
use cell_domain::evolution::EvolutionLog;
use std::fs;
...
mod tests {
    ...
    fn test_archive_and_history() {
        ...
        log.phase = cell_domain::evolution::EvolutionPhase::Completed;

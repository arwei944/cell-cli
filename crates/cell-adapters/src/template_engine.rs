use cell_application::ports::code_generator::{CodeGeneratorPort, GeneratedFile};
use cell_domain::cell_spec::{CellSpec, PortSpec, AdapterSpec};
...
mod tests {
    use super::*;
    use cell_domain::cell_spec::PortKind;
    use cell_domain::cell_spec::AdapterKind;

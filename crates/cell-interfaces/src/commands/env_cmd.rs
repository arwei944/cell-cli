use cell_application::multi_env_config_service::{MultiEnvConfigService, Environment};
use cell_domain::errors::CellResult;
use crate::cli::{EnvArgs, EnvSub};
        ...
        EnvSub::Diff { base, target } => {
            ...
            if report.drift_count > 0 {
                ...
                for diff in &report.diffs {
                    if diff.diff_type != cell_application::multi_env_config_service::DiffType::Same {
                        let icon = match diff.diff_type {
                            cell_application::multi_env_config_service::DiffType::Added => "+",
                            cell_application::multi_env_config_service::DiffType::Removed => "-",
                            cell_application::multi_env_config_service::DiffType::Changed => "~",
                            _ => " ",
                        };

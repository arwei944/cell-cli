use cell_application::rca_v2_service::RCAV2Service;
use cell_domain::errors::CellResult;
use cell_domain::rca_engine_v2::{RCASignal, SignalSeverity, SignalType};
use crate::cli::{RcaArgs, RcaSub};
use chrono::Utc;
use uuid::Uuid;
    ...
    match args.sub {
        ...
        RcaSub::List {} => {
            ...
            if analyses.is_empty() {
                ...
                println!("  共 {} 条记录\n", analyses.len());
                println!("  {:<36}  {:<15}  {:<10}  {:<10}  Root Cause",

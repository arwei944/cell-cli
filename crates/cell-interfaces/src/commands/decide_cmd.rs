use cell_application::decision_engine::DecisionEngineService;
use cell_domain::errors::CellResult;
use crate::cli::{DecideArgs, DecideSub};
        ...
        DecideSub::Rules {} => {
            ...
            for (i, rule) in service.get_rules().iter().enumerate() {
                ...
                let sev = match rule.severity {
                    cell_application::decision_engine::DecisionSeverity::Low => "🟢",
                    cell_application::decision_engine::DecisionSeverity::Medium => "🟡",
                    cell_application::decision_engine::DecisionSeverity::High => "🟠",
                    cell_application::decision_engine::DecisionSeverity::Critical => "🔴",
                };

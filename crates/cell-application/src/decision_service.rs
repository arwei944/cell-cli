...
impl<T: DecisionStorePort> DecisionService<T> {
    ...
    pub fn record_decision(
        ...
        record.made_by = made_by.map(std::string::ToString::to_string);
    ...
    pub fn add_alternative(
        ...
        let mut decision = self
            ...
            .ok_or_else(|| cell_domain::errors::CellError::Config("Decision not found".to_string()))?;
    ...
    pub fn list_decisions(
        ...
        decisions.sort_by_key(|d| std::cmp::Reverse(d.made_at));
        Ok(decisions)
    }
    ...
    impl DecisionStorePort for MockDecisionStore {
        ...
        fn load_by_id(&self, _path: &str, id: &str) -> CellResult<Option<DecisionRecord>> {
            Ok(self
                ...
                .unwrap()
                .iter()
                .find(|d| d.id.to_string() == id || cell_domain::decision::simple_id(&d.id) == id.to_uppercase())
                .cloned())
        }
